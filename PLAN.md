...
| Phase | Skill | When |
|---|---|---|
| Before Phase 3 | `ui-ux-pro-max` | Get exact spec for chess panel dark-mode layout |
| Before Phase 7 | `ui-ux-pro-max` | Dot nav hover state, pill label animation spec |
| After Phase 2 | `simplify` | ChartSpine code quality pass |
| After Phase 7 | `simplify` | JumpNav code quality pass |
| After Phase 11 | `simplify` | Full final pass |

---

## Current Status
- [x] `@gsap/react` installed
- [x] `context7` MCP configured in `.mcp.json` and `settings.json`
- [x] `ui-ux-pro-max` skill active
- [x] `playwright` MCP active
- [x] `simplify` skill available
- [ ] Phase 1 — not started
- [ ] Phase 2 — not started
- [ ] Phase 3 — not started
- [ ] Phase 4 — not started
