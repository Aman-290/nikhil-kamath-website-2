    ...
    <section className="relative w-full z-10 min-h-[120vh] bg-[#050505] flex flex-col justify-center overflow-hidden py-32 rounded-t-[3rem] shadow-[0_-20px_60px_rgba(0,0,0,0.8)] border-t border-white/5">
      ...
      <div className="container mx-auto px-6 md:px-16 xl:px-24 max-w-[1400px] relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:items-center max-w-7xl mx-auto mb-32">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-12">
              <span className="font-mono text-5xl md:text-7xl text-[#D4FF00] tracking-tighter drop-shadow-[0_0_20px_rgba(212,255,0,0.3)]">At 36.</span>
          ...
          >
            <div className="absolute inset-0 bg-[#D4FF00]/10 blur-[60px] rounded-full mix-blend-screen z-0" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">       
          ...
          {/* Metric Card 2 */}
          <motion.div
            className="group relative p-10 rounded-3xl bg-gradient-to-b from-[#D4FF00]/10 to-transparent border border-[#D4FF00]/20 hover:border-[#D4FF00]/40 transition-colors duration-500 overflow-hidden flex flex-col justify-between min-h-[360px] shadow-2xl"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-baseline gap-1 mb-2">
                <span className="font-clash text-5xl lg:text-7xl text-[#D4FF00] tracking-tight">$200</span>
                <span className="font-clash text-3xl text-[#D4FF00]/60">M</span>
              </div>
